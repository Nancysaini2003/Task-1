...
# Define the cos_clicked function
def cos_clicked():
    # Add your code for the cos_clicked function here
    pass  # Placeholder for the function's code

# Create the cos_btn button with the cos_clicked function as the command
...
# Define the btnml_clicked function
def btnml_clicked():
    # Add your code for the btnml_clicked function here
    pass  # Placeholder for the function's code

# Create the btnml button with the btnml_clicked function as the command
